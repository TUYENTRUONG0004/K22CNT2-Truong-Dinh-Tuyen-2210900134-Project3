    ...
    <div class="container mt-5 bg-white p-4 rounded">
        ...
        <form action="${pageContext.request.contextPath}/lichsudatphong/update" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="date" name="tdt_ThoiGianBatDau" class="form-control" value="${lichSu.tdt_ThoiGianBatDau}" required />
            </div>
            <div class="mb-3">
                <label class="form-label">Ngày Kết Thúc:</label>
                <input type="date" name="tdt_ThoiGianKetThuc" class="form-control" value="${lichSu.tdt_ThoiGianKetThuc}" required />
            </div>
            <div class="mb-3">
