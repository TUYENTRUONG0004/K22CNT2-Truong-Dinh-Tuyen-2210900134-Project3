...
<body>
    ...
    <a class="add-link" href="${pageContext.request.contextPath}/thietbi/add">➕</a>
    <table>
        <thead>
            <tr>
                <th>Mã Thiết Bị</th>
        ...
        <tbody>
            <c:forEach var="tb" items="${thietBiList}">
                <tr>
                    ...
                    <td>${tb.tdt_GhiChu}</td>
                    <td>
                        <a href="${pageContext.request.contextPath}/thietbi/edit/${tb.tdt_MaThietBi}">Sửa</a>
                        |
                        <a href="${pageContext.request.contextPath}/thietbi/delete/${tb.tdt_MaThietBi}"
