...
<body>
    <div class="container">
        <h1 class="text-center">Danh Sách Thiết Bị</h1>
        <div class="mb-3 text-center">
            <a href="${pageContext.request.contextPath}/thietbi/add" class="btn btn-success">Thêm Thiết Bị</a>
        </div>
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                <c:forEach var="tb" items="${thietBiList}">
                    <tr>
                        ...
                        <td>${tb.tdt_GhiChu}</td>
                        <td>
                            <a href="${pageContext.request.contextPath}/thietbi/edit/${tb.tdt_MaThietBi}" class="btn btn-primary btn-sm">Sửa</a>
                            <a href="${pageContext.request.contextPath}/thietbi/delete/${tb.tdt_MaThietBi}" class="btn btn-danger btn-sm" onclick="return confirm('Bạn có chắc chắn muốn xóa?');">Xóa</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
