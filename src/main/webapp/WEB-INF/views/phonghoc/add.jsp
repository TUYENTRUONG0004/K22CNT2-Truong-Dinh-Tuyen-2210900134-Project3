...
<body>
    ...
    <!-- Form gửi dữ liệu đến /phonghoc/save bằng POST -->
    <form action="${pageContext.request.contextPath}/phonghoc/save" method="post">
        <div>
        ...
        <div>
            ...
            <input type="text" name="tdt_TenPhong" required="required"/>
        </div>
        <div>
    ...
    <button type="button" class="btn" onclick="location.href='${pageContext.request.contextPath}/phonghoc/list'">
